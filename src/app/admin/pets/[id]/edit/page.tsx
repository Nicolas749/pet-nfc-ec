...
export default function EditPetProfile({ params }: { params: Promise<{ id: string }> }) {
  ...
  useEffect(() => {
    async function loadPet() {
      try {
        // En MVP podemos buscar el pet a través de la API general o crear un endpoint GET /[id].
        // Usaremos GET /api/pets y filtraremos por facilidad.
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center">
                <span className="px-4 py-2.5 bg-gray-100 border border-r-0 border-gray-200 rounded-l-xl text-gray-500 text-sm">/p/</span>
            ...
            <div className="space-y-2">
              ...
              <input defaultValue={initialData.photoUrl || ""} type="url" id="photoUrl" name="photoUrl" className="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all outline-none" />
            </div>
          </div>
