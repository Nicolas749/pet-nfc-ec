        ...
        <form onSubmit={handleSubmit} className="p-6 md:p-8 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              <input type="url" id="photoUrl" name="photoUrl" className="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all outline-none" placeholder="https://ejemplo.com/foto.jpg" />
            </div>
          </div>
